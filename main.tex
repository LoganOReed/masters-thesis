...
\break
  ...
  In this thesis we introduce a numerical approach adapted to the minimization of the first eigenvalue of the Laplacian with respect to the Dirichlet boundary condition on a polygonal domain of fixed area.
...
\begin{figure}[hbt!]
    ...
    \caption{Domains and Eigenfunctions Obtained after $1000$ Iterations for}
\end{figure}
